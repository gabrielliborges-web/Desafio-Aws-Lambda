...
export function SidebarLayout({
  ...
  return (
    <div className="relative isolate flex min-h-svh w-full bg-gradient-to-r from-purple-900 via-blue-900 to-pink-900 max-lg:flex-col dark:from-purple-800 dark:via-purple-700 dark:to-blue-700">
      ...
      <main className="flex flex-1 flex-col pb-2 lg:min-w-0 lg:pl-64 lg:pr-2 lg:pt-2">
        <div className="grow  lg:rounded-lg lg:bg-zinc-100 lg:shadow-sm lg:ring-1 lg:ring-zinc-200 dark:lg:bg-zinc-800 dark:lg:ring-zinc-700">
